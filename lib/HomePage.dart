import 'package:estateapp/property/property_listing.dart';
...
Future<void> repeatNotification(String propertyName, String contact) async {
  var androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'm_channel_id', 'm_channel_name', 'm_channel_description');
  var iOSPlatformChannelSpecifics = IOSNotificationDetails();
  var platformChannelSpecifics = NotificationDetails(
      androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
  await flutterLocalNotificationsPlugin.periodicallyShow(
      0, propertyName, contact, RepeatInterval.Daily, platformChannelSpecifics);
}
